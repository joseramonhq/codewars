...
public class KataTests {
    ...
    public void sensorAnalysis_BasicTest1() {
        ...
        double[] expectedResult = {118.6275, 3.5779};
        double[] actual = Kata.sensorAnalysis(sensorData);
    ...
    public void sensorAnalysis_BasicTest2() {
        ...
        double[] expectedResult = {215.2265, 68.4014};
        double[] actual = Kata.sensorAnalysis(sensorData);
        assertEquals(Arrays.toString(expectedResult), Arrays.toString(actual));
    }
    ...
    public void sensorAnalysis_RandomTests() {
        for (int i = 0; i < 40; i++) {
            ...
            double[] expectedResult = sensorAnalysisTest(sensorData);
            System.out.println("testing");
            for (Object[] sensorDatum : sensorData) System.out.println(Arrays.toString(sensorDatum));
            System.out.println("result");
            System.out.println(Arrays.toString(Kata.sensorAnalysis(sensorData)));
            assertEquals(Arrays.toString(expectedResult), Arrays.toString(Kata.sensorAnalysis(sensorData)));
        }
    }
}
